...
@implementation PropertyNewsView
...
- (void)reload:(BOOL)noRefresh
{
    ...
    if ([UserModel Instance].isNetworkRunning) {
        ...
        NSString *getNewsListUrl = [Tool serializeURL:[NSString stringWithFormat:@"%@%@", api_base_url, api_findNewsInfoByPage] params:param];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        NSString *pushDetailHtm = [NSString stringWithFormat:@"%@%@%@", api_base_url, htm_propertyNewsDetailHtm ,news.newsId];
