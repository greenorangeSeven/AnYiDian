...
@implementation IntegralMarketView
...
- (void)getUrl
{
    ...
    [param setValue:@"1" forKey:@"hadIntegral"];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.priceLb.text = [NSString stringWithFormat:@"积分:%d", commodity.integral];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Commodity *commodity = [commoditys objectAtIndex:indexRow];
    if (commodity) {
        IntegralMarketDetailView *detailView = [[IntegralMarketDetailView alloc] init];
