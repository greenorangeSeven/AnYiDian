...
@interface PreferentialDetailView ()
{
    MBProgressHUD *hud;
...
@implementation PreferentialDetailView
...
- (void)viewDidLoad {
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@%@%@", api_base_url, htm_preferentialPolicyDetail, self.activity.activityId];
